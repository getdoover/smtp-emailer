...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/getdoover/smtp-emailer?quickstart=1)
...
rename the `smtp_emailer` package, and replace the sample config, tags, UI, and state machine
with your own.
...
Configuration fields are declared in [`src/smtp_emailer/app_config.py`](src/smtp_emailer/app_config.py).
...
The sample app publishes a few example tags via [`src/smtp_emailer/app_tags.py`](src/smtp_emailer/app_tags.py):
